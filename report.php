...
<div class="row">
	<div class="col-sm-12 rpt-are">	
		<div class="col-sm-4 col-sm-offset-4 border">
			...
			<div class="row">
				<div class="col-sm-4">
					<a href="rp2.php" role="button" class="btn btn-info btn-large">Chinese films on Theatre</a>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-4">
					<a href="rp3.php" role="button" class="btn btn-info btn-large" >Bollywood Top Movie</a>
				</div>
			</div>	
		</div>
	</div>
